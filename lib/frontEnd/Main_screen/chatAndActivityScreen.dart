...
import 'package:leaf/frontEnd/Services/ChatManagement/chat_screen.dart';
import 'package:leaf/frontEnd/Services/search_screen.dart';
...
import '../../Global_Uses/enum_gen.dart';
...
class _ChatAndActivityScreenState extends State<ChatAndActivityScreen> {
  ...
  final List<String> _allUserConnectionActivity = ['Leaf', 'Labib'];
              ...
              OpenContainer(
                ...
                closedBuilder: (context, closeWidget) {
                  return CircleAvatar(
                    backgroundColor: const Color.fromRGBO(34, 48, 60, 1),
                    backgroundImage:
                    ExactAssetImage('assets/images/leaf.png'),
