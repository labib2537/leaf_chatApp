...
import 'package:leaf/Backend/sqlite_management/local_database_management.dart';
import 'package:leaf/frontEnd/AuthUI/common_auth_method.dart';
  ...
  Widget build(BuildContext context) {
    return SafeArea(
        child: Scaffold(
          ...
          //backgroundColor: Color.fromRGBO(153, 255, 230, 1),
      body: LoadingOverlay(
    ...
    key: this._takeUserPrimaryInformationKey,
          child: ListView(
            ...
            _upperHeading(),
            commonTextFormField(bottomPadding: 50,hintText: 'Username', validator: (inputUserName){
            ...
            commonTextFormField(hintText: 'User About', validator: (inputVal) {
