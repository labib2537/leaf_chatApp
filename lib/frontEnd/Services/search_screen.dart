...
import 'package:leaf/Backend/firebase/OnlineDatabaseManagement/cloud_data_management.dart';
...
class _SearchScreenState extends State<SearchScreen> {
  ...
  Future<void> _initialDataFetchAndCheckUp() async {
    ...
    await _cloudStoreDataManagement.getAllUsersListExceptMyAccount(currentUserEmail: FirebaseAuth.instance.currentUser!.email.toString());
